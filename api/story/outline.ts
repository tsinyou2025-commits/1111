...
const stylePrompts: Record<string, string> = {
  ...
  history: '历史叙事风格。语言精炼、客观，知识信息密度高，但绝不使用编号列表、小标题、分点论述这种答题式结构——这是对历史叙事的裹渎。整体性、故事性、运动感是最高原则：每一章本身就是一篇完整的叙事散文，有起有伏、有张有弛，逻辑的起承转合必须通过叙事本身的流动来实现，而不是靠编号分割。段落之间要有内在的因果链条和时间脉络，让读者感受到历史作为一个运动整体的动力。人物是历史动力学的核心参数——人物的性格、信念、行事风格、关键经历必须直接融入叙事本身，在讲到具体历史事件时自然地展现人物的特质与抉择。人物首次登场时用一两句话交代身份与时代坐标即可，其性格与动机应在后续叙事中通过具体事件逐步浮现。无废话、无抒情、无客套话。叙事语调沉静、克制、富有洞察力，适合夜间聆听。',
