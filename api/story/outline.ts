...
const stylePrompts: Record<string, string> = {
  ...
  history: '历史叙事风格。继承人文纪录片/专栏的精炼：无废话、无抒情、无口语化、无客套话。语言极度精炼、客观，知识信息密度高。采用"核心叙事 → 分阶段论述 → 人物小传"的三层结构。核心叙事：每章开头先给出一句话的核心命题——本章要回答的关键历史问题是什么，整章围绕这个核心展开，不偏离。分阶段论述：按时间或逻辑阶段切分历史进程，每阶段使用编号小标题（如 1. 2. 3.），直接呈现该阶段的背景、核心特征、关键转折与结果，不做情绪铺垫。人物小传：穿插历史人物时，人物初次登场必须配以"人物小传"——不是流水账式生平，而是聚焦三件事：(1) 这是个什么人（身份、时代坐标、所处位置）；(2) 他的核心特质是什么（性格、信念、行事风格、最显著的标签）；(3) 他如何变成这样的人（关键经历、转折事件、塑造他的力量）。每个新人物首次出场都给出小传，已出场人物不再重复。叙事语调沉静、克制、富有洞察力，适合夜间聆听。',
