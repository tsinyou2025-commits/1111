...
const defaultStyleOptions = [
  ...
  { id: 'history', name: '历史叙事', desc: '朴实语言·深遂思路·史料引用', icon: '🏺' },
  { id: 'colloquialhistory', name: '白话历史', desc: '叙事散文·起承转合·人物融入', icon: '📖' },
...
export default function Home() {
  ...
  const { settings, setCurrentStory, currentStory, setChapters } = useAppStore()
        ...
        <div className="text-center mb-10">
          ...
          <div className="inline-flex flex-col items-center gap-2 px-4 py-2.5 rounded-2xl bg-slate-800/50 border border-slate-700/50 text-xs text-slate-500">
            <div className="flex items-center gap-2">
              <span className="font-mono text-slate-300">v2.0.4</span>
